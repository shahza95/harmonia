...
public class CommentEntityAdapter {
	...
	public CommentEntity toEntity(Comment comment) {
		...
		commentEntity.setLecture(this.lectureAdapter.toEntity(comment
				.getLecture()));
	...
	public Comment toDomain(CommentEntity commentEntity) {
		...
		commentBuilder.message(commentEntity.getMessage()).lecture(
				this.lectureAdapter.toDomain(commentEntity.getLecture()));
