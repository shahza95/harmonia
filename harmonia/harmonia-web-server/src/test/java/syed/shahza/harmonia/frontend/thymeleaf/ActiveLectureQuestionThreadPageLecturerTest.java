...
public class ActiveLectureQuestionThreadPageLecturerTest extends ThymeleafTemplateTest {
    private HtmlElements tags;
    private LectureDto lectureDto;
    private QuestionDto questionDto;
    private Map<String, Object> model;
    
    public ActiveLectureQuestionThreadPageLecturerTest() {
        super("/lecturer/activeLectureQuestionThread");
    }
    ...
    @Test
    public void shouldHaveOneButton() throws NodeSelectorException {
    	assertThat(this.tags.matching("input").size(), is(1));
    }
    
    
    @Test
    public void shouldOneTextareaForAnswer() throws NodeSelectorException {
